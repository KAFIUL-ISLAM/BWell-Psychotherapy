...
const NotFound = () => {
    return (
        <div className='bg-[#91D0CC] min-h-screen flex justify-center items-center'>
            <div className='bg-white md:px-8 rounded-2xl shadow-inner shadow-black pb-12'>
                ...
                <h1 className='text-violet-800 font-bold text-6xl text-center'>Oops! Page Not FOund!!</h1>
            </div>
        </div>
    );
};
